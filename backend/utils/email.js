    ...
    const mailOptions = {
        ...
        html: `
            <div style="font-family: Arial, sans-serif; color: #000; padding: 20px; border: 2px solid #000;">
                ...
                <a href="${AWS_SERVER_URI}confirm-reset-email?code=${code}" style="text-decoration: none; display: inline-block; padding: 10px 20px; background-color: #fff; color: #000; border: 2px solid #000; border-radius: 5px; transition: background-color 0.3s, color 0.3s, border-color 0.3s;">
                    按我重置密碼
                </a>
            </div>`
    };
    ...
    const mailOptions = {
        ...
        html: `
            <div style="font-family: Arial, sans-serif; color: #000; padding: 20px; border: 2px solid #000;">
                ...
                <a href="${AWS_SERVER_URI}confirm-register-email?code=${code}" style="text-decoration: none; display: inline-block; padding: 10px 20px; background-color: #fff; color: #000; border: 2px solid #000; border-radius: 5px; transition: background-color 0.3s, color 0.3s, border-color 0.3s;">
                    註冊帳號
                </a>
            </div>`
    };
