...
class _SignUpPageState extends State<SignUpPage>{
  ...
  var emailSignUpTextFieldController,passwordSignUpTextFieldController,nameSignUpTextFieldController;
  @override
  void initState(){
    super.initState();
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          ...
          onPressed: () async{
            ...
            final signUpres = await signUpAPI(_signUpEamil,_signUpName,_singUppassword);
